 ...
 * 
 */
@WebServiceClient(name = "WeatherWS", targetNamespace = "http://WebXml.com.cn/", wsdlLocation = "file:/G:/webService/ws.webxml.com.cn.xml")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/G:/webService/ws.webxml.com.cn.xml");
