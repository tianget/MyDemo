...
<table style="padding-left: 20px;top:50px;left:40px;width:1222px">
	  ...
	  <tr style="height:40px;">
	    <th>
	    	<table style="width:750px;height: 280px;margin:auto;border:1px solid green;">
				<tr>
					<td>客户姓名：${lovName }</td>
			...
			buttons:[
				...
				},
				{
					...
					handler:function(){	
			        	...
			        	$("#client_lovs").datagrid('reload');
						$("#option").dialog('close').form('reset');
				},		
				}
			]
	  })
	...
	$(function(){
		$('#client_lovs').datagrid({    
	    	url:'../clientLoving/getLovs',
		    height:450,
		    striped:true,
		    columns:[[
		            {field:'rid',checkbox:true},
		            {field:'name',title:'提醒名称',width:120,align:'center'},
		            {field:'time',title:'提醒时间',width:120,align:'center'},
		            {field:'type',title:'提醒类型',width:120,align:'center'},
		            {field:'frequency',title:'提醒频率',width:120,align:'center'},
		    ]],
		    rownumbers:'true',
		    multiSort:'true',
		    singleSelect:'true',
