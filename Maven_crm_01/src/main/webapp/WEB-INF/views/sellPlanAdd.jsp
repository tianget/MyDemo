...
<body>
    ...
    <form:form id="sellForm"  action="javascript:void(0)"  commandName="sellPlan"  method="post">
       <table id="sellTable">
             ...
             <tr>
                  <td>计划编码：</td>
                  <td><form:input  path="coding" class="easyui-validatebox"  data-options="required:true" onchange="checkCoding(this)" /><span id="sellMsg"></span></td>
             </tr>
              <tr>
                  <td>计划月份：</td>
             ...
             <tr>
                  <td></td>
                  <td><input  type="image" onclick="return1Plan()"  src="../easyui/themes/icons/arrow-left.png"   />&nbsp;&nbsp;&nbsp;&nbsp;<input type="image" onclick="addPostPlan()" src="../easyui/themes/icons/button-white-check.png"   /></td>
             </tr>
       </table>
     </form:form>
